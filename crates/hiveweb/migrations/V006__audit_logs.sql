...
CREATE TABLE IF NOT EXISTS audit_logs (
    ...
    CONSTRAINT fk_audit_operator FOREIGN KEY (operator_id) REFERENCES admins(id) ON DELETE SET NULL,
    CONSTRAINT fk_audit_target FOREIGN KEY (target_admin_id) REFERENCES admins(id) ON DELETE SET NULL
